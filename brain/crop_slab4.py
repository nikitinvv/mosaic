...
fnameout = '/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped/'
os.system('rm -rf /data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped/*')
...
fname = '/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped/'
fnameout = '/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped_ward/'
nfiles = len(next(os.walk('/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped/'))[2])
id_tmp = nfiles//2
data = tifffile.imread(f'{fname}/recon_{id_tmp:05}.tiff')
mmin,mmax=find_min_max(data)
print(mmin,mmax)

os.system('rm -rf /data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped_ward/*')
...
write_parallel(fnameout,data)
exit()
# # fname = '/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped_ward/recon/r_00000.tiff'
# # fnameout = '/data/2022-11-Nikitin/alcf/slab4_new/mosaic_rec_cropped_ward2/recon'
