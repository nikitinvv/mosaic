...
def touint8(psi, mmin, mmax):
    ...
    return psi
fname = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin/recon_00000.tiff'
fnameout = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped/recon'

os.system('rm -rf /data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped/*')

data = dxchange.read_tiff_stack(fname,ind=range(350,570))[:]
data[:] = -data
...
fname = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped/recon_00000.tiff'
fnameout = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped_ward/recon'

data = dxchange.read_tiff_stack(fname,ind=range(0,220))[:]


os.system('rm -rf /data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped_ward/*')
# mmin,mmax=find_min_max(data[data.shape[0]//2])
mmin = -0.0029269056 
mmax = 0.0068289298

data = data.swapaxes(0,1)
data = ward_parallel(data,31,mmin,mmax)
data = data.swapaxes(0,1)
...
# fname = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped_ward/recon/r_00000.tiff'
# fnameout = '/data/2022-11-Nikitin/slab3/mosaic_rec/mosaic_bin2_rec_bin_cropped_ward2/recon'
